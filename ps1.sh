...
echo "[*] Set ls and grep colors? [y/n]"; read yn; case $yn in
	[yY] | [yY][Ee][Ss] )
...
echo "[*] Append your new PS1 to ~/.bashrc? [y/n]"; read yn; case $yn in
	[yY] | [yY][Ee][Ss] )
		echo "[*] Appending to ~/.bashrc"
		echo "# [*] New PS1 Configuration:" >> ~/.bashrc
		echo "export PS1='\[\e]0;\u@\h: \w\a\]${debian_chroot:+($debian_chroot)}\[\033[1;34m\]root\[\033[1;39m\]@$input:\[\033[00m\]\$ ' " >> ~/.bashrc
