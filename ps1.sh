...
# BROKE		echo "# [*] New PS1 Configuration:" >> ~/.bashrc; echo "export PS1='\[\e]0;\u@\h: \w\a\]${debian_chroot:+($debian_chroot)}\[\033[1;34m\]root\[\033[1$" >> ~/.bashrc # This does not append correclty due to $var not being escaped properly
		echo "[*] Exiting"
		;;
